...
export class article1640768438994 implements MigrationInterface {
    name = 'article1640768438994'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`article\` (\`id\` int NOT NULL AUTO_INCREMENT, \`code\` varchar(20) NOT NULL, \`name\` varchar(60) NOT NULL, \`price\` decimal(6,2) NOT NULL, \`categoryId\` int NOT NULL, UNIQUE INDEX \`IDX_8297226767489db5af1952d293\` (\`code\`), UNIQUE INDEX \`IDX_95662f989b79a03ba2c6776f46\` (\`name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`IDX_8297226767489db5af1952d293\` ON \`article\``);
